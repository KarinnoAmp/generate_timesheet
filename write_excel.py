...
class GenerateExcel:
    ...
    #     # For each project (prepare write sheet excel)
    ...
    def new_write_excel(self, data: dict):
        ...
        for project in tqdm(data, ncols=100):
            ...
            self.set_header_excel_style(style_frame)
            self.set_person_row_style(style_frame, person_index_row)
    ...
    @staticmethod
    def set_person_row_style(style_frame, person_row: list):
        cyan_color: str = '46bdc6'
...
if __name__=='__main__':
    ...
    dict_data = generater.get_dict_data_from_jsonfile('./export_data_test.json')
